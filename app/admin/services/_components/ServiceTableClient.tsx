                    ...
                    <tbody className="divide-y divide-neutral-200 text-sm">
                        {services.map(service => (
                            <tr key={service.id} className="hover:bg-neutral-50/50 transition-colors">
                                ...
                                <td className="px-4 py-3 text-neutral-500">{service.iconKey || "—"}</td>
                                <td className="px-4 py-3 text-center text-neutral-500">{service.sortOrder}</td>
                                ...
                                <td className="px-4 py-3 text-right space-x-2">
                                    <button onClick={() => onEdit(service.id)} className="text-neutral-500 hover:text-brand-red transition-colors p-1" title="Edit">
                                        <Edit2 className="w-4 h-4" />
                                    </button>
                                    <button onClick={() => onDelete(service.id)} className="text-neutral-500 hover:text-red-600 transition-colors p-1" title="Delete">
