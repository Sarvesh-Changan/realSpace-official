...
import { Box, KeyRound, Wrench, ClipboardCheck } from "lucide-react";
          ...
          {KEY_FEATURES.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex h-24 w-24 sm:h-28 sm:w-28 shrink-0 items-center justify-center rounded-xl border border-brand-yellow/80 bg-brand-bgAlt/50 p-4">
                  <Icon className="h-10 w-10 sm:h-12 sm:w-12 text-brand-red" />
                </div>
