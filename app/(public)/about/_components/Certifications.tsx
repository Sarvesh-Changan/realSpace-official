        ...
        {certifications.map((cert, idx) => {
          ...
          return (
            ...
            >
              ...
              {cert.textureUrl && (
                <Image src={cert.textureUrl} alt="" fill sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" className="object-cover transition-transform duration-700 ease-out group-hover:scale-105" />
              )}
              ...
              <div className="absolute inset-x-0 top-[19%] flex justify-center px-4">
                <div className="relative flex h-20 w-20 items-center justify-center rounded-full border-2 border-white/80 bg-brand-warmWhite/95 p-2 shadow-[0_5px_15px_rgba(0,0,0,0.22)] sm:h-24 sm:w-24 sm:p-2.5">
                  ...
                  <Image src={displayImage} alt={`${cert.title} certification logo`} fill sizes="96px" className="object-contain p-3 sm:p-3.5" />
                </div>
              </div>
