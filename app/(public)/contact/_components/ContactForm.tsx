    ...
    <div className="bg-brand-bg rounded-2xl p-5 sm:p-8 md:p-10 border border-neutral-200 shadow-sm">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
        ...
        <button
          ...
          className="btn-kunku w-full min-h-[48px] font-bold py-3.5 px-6 rounded-xl transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center text-sm sm:text-base cursor-pointer"
        >
