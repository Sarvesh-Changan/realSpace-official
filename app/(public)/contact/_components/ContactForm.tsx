...
export function ContactForm() {
  ...
  return (
    <div className="bg-brand-bg rounded-2xl p-6 md:p-10 border border-neutral-200 shadow-sm">
      <h3 className="text-2xl font-bold text-brand-text mb-6">
        Send us a Message
      </h3>

      {serverError && (
        <div className="mb-6 p-4 bg-red-50 border border-red-200 text-brand-red text-sm rounded-lg">
          {serverError}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <select
            id="service"
            {...register("service")}
            className="w-full px-4 py-3 rounded-lg border border-neutral-300 bg-white text-brand-text focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-brand-red transition-shadow appearance-none"
          >
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            {...register("message")}
            className="w-full px-4 py-3 rounded-lg border border-neutral-300 bg-white text-brand-text focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-brand-red transition-shadow resize-none"
        ...
        <button
          ...
          className="w-full bg-brand-red hover:bg-red-700 text-white font-semibold py-4 px-6 rounded-lg transition-colors disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
        >
