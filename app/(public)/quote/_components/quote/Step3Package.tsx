  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-2xl font-serif text-[#1C1C1C] mb-2">Select your material package</h2>
        <p className="text-[#6D6A66]">Choose the level of finish and any extra services you need.</p>
      </div>
        ...
        {PACKAGES.map((pkg) => {
          ...
          return (
            <button
              ...
              className={clsx(
                "relative p-6 rounded-xl border-2 transition-all duration-200 text-left flex flex-col h-full",
                "hover:shadow-md",
                isSelected 
            ...
            >
              ...
              <p className="text-sm text-[#6D6A66] leading-relaxed mt-auto">
                {pkg.desc}
              </p>
            </button>
          );
      ...
      <div className="mt-8 border-t border-[#E8E2DA] pt-8">
        <h3 className="text-lg font-medium text-[#1C1C1C] mb-4">Additional Services</h3>
